function horizontalGroupBarChart(config) {
    ...
    var horBarTooltip = {
        ...
        showTooltip: function (pie, index) {
            ...
            d3.select(pie.mainDiv).select("#" + pie.cssPrefix + "tooltip" + index)
                .transition()
        ...
        moveTooltip: function (pie) {
            d3.select(pie.mainDiv).selectAll("#" + pie.cssPrefix + "tooltip" + horBarTooltip.currentTooltip)
                .attr("transform", function (d) {
        ...
        hideTooltip: function (pie, index) {
            ...
            d3.select(pie.mainDiv).select("#" + pie.cssPrefix + "tooltip" + horBarTooltip.currentTooltip)
